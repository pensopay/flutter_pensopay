...
public protocol PPPaymentWindowControllerDelegate {
...
class PPPaymentWindowControllerDelegateCallbacksWrapper: PPPaymentWindowControllerDelegate {
    var onCancel: (() -> Void)?
...
public class PPPaymentWindowController: UIViewController {
    ...
    public var delegate: PPPaymentWindowControllerDelegate?
    ...
    public convenience init(paymentUrl: String, delegate: PPPaymentWindowControllerDelegate ) {
    ...
    public convenience init(paymentUrl: String, onCancel: @escaping () -> Void, onResponse: @escaping (Bool) -> Void) {
        ...
        let delegateWrapper = PPPaymentWindowControllerDelegateCallbacksWrapper()
...
extension PPPaymentWindowController: WKNavigationDelegate {
...
//        Pensopay.logDelegate?.log("An error occured in PPPaymentWindowController, didFailNavigation: \nError: \(error.localizedDescription)")
    }
    
    public func webView(_ webView: WKWebView, didFailProvisionalNavigation navigation: WKNavigation!, withError error: Error) {
//        Pensopay.logDelegate?.log("An error occured in PPPaymentWindowController, didFailProvisionalNavigation: \nError: \(error.localizedDescription)")
    }
    
}

extension PPPaymentWindowController: WKUIDelegate {
