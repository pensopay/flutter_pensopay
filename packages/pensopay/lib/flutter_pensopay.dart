...
class Pensopay {
  ...
  static Future<Payment> makePayment({required String currency, required String orderId, required double amount, required String facilitator, int autoCapture = 0,}) async {
    try {
