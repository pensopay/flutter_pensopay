...
class PPRefundPaymentRequest(params: PPRefundPaymentParameters): PPrequest<PPPayment>(Request.Method.POST, "/payments/${params.payment_id}/refund", params, PPPayment::class.java) {}
